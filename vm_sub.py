...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("kjko/ipinfo")
    client.subscribe("kjko/ipinfo")
    client.subscribe("kjko/date")
    client.subscribe("kjko/time")

    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("kjko/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("kjko/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("kjko/date", on_message_from_date)
    client.message_callback_add("kjko/time", on_message_from_time)
...
def on_message_from_ipinfo(client, userdata, message):
    print("Custom callback - IP Address:" + message.payload.decode())

# custom date callback
